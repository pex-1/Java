...
//		zaposleniciTable.setOnMouseClicked(new EventHandler<MouseEvent>() {
//			@Override
//			public void handle(MouseEvent event) {
//			if(event.getClickCount() > 1) {
//			//prikaz ekrana za unos nove komunikacije
//			}
//	});
	...
	public static void dodajNovogZaposlenika(Zaposlenik zaposlenik) {
